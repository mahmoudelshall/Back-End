...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (count($errors) > 0) {
        ...
        $sql = "insert into user (u_name,u_email,u_pass,u_phone,u_role) values ('$name','$email','$password','$phone',2)";
...
<head>
    ...
    <link href="http://localhost/group8/week3/admin/css/styles.css" rel="stylesheet" />
